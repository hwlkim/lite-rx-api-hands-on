...
//			.flatMap(tuple -> Flux.just(new User(tuple.getT1(), tuple.getT2(), tuple.getT3()))); // OK
...
//		return Mono.just(flux.toStream().collect(Collectors.toList())); // ok
//		return flux.collect(Collectors.toList()); // ok
